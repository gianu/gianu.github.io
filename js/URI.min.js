...
k=0;3>k;k++)if("0"===g[0]&&1<g.length)g.splice(0,1);else break;f[b]=g.join("")}var g=-1,q=k=0,n=-1,r=!1;for(b=0;b<h;b++)r?"0"===f[b]?q+=1:(r=!1,q>k&&(g=n,k=q)):"0"==f[b]&&(r=!0,n=b,q=1);q>k&&(g=n,k=q);1<k&&f.splice(g,k,"");g=f.length;h="";""===f[0]&&(beststr=":");for(b=0;b<g;b++){h+=f[b];if(b===g-1)break;h+=":"}""===f[g-1]&&(h+=":");return h}}});(function(f){function g(a){throw RangeError(p[a]);}function h(a,c){for(var d=a.length;d--;)a[d]=c(a[d]);return a}function b(a){for(var c=[],d=0,b=a.length,w,e;d<b;)w=a.charCodeAt(d++),55296==(w&63488)&&d<b?(e=a.charCodeAt(d++),56320==(e&64512)?c.push(((w&1023)<<10)+(e&1023)+65536):c.push(w,e)):c.push(w);return c}function k(a){return h(a,function(a){var c="";65535<a&&(a-=65536,c+=C(a>>>10&1023|55296),a=56320|a&1023);return c+=C(a)}).join("")}function q(a,c,d){var b=0;a=d?z(a/B):a>>1;for(a+=z(a/c);a>
